...
class AddAddress extends StatefulWidget {
  ...
  const AddAddress({super.key, this.address, this.hasAddress = false, this.fromCart = false,
    this.firstName,
    this.lastName,
    this.contactNumber,
    this.emailAddress,
...
class _AddAddressState extends State<AddAddress> {
  ...
  late String pageFrom;
            ...
            showDialog(
              ...
              builder: (context) => AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    Text('Sorry, Delivery location is invalid!'),
                      ...
                      onTap: () {
                        ...
                        Get.to(() => DeliverylocationsPage(),
                          arguments: {
                            ...
                            'pageFrom':Get.arguments?['pageFrom']=='addresspage'?'addresspage':'cartpage'
                          }
                        );
                      },
                      child: Text(
    ...
    void initState() {
      ...
      postalCode = TextEditingController(text: widget.postalCodeController?.text ?? '');
      ...
      if (arguments.isNotEmpty) {
        ...
        contactNumber = TextEditingController(text: arguments['contactNumber'] ?? '');
        emailAddress = TextEditingController(text: arguments['emailAddress'] ?? '');
        streetAddress = TextEditingController(text: arguments['streetAddress'] ?? '');
  ...
  Widget build(BuildContext context) {
    ...
    print('Page From: ${Get.arguments?['pageFrom']}');// It should print 'addresspage'
    ...
    if (postalCode.text.isNotEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        try {
          ...
          var data = await profileViewModel.getAddressFromPincode(postalCode.text);
    ...
    return Scaffold(
      appBar: MyAppBar(
        ...
        leading: BackButton(
          onPressed: () {
            widget.fromCart ? Get.to(()=>AddressPage(fromCart: widget.fromCart,)) : Get.back();
          },
        ),
      ),
                        ...
                        if (firstName.text.isNotEmpty &&
                          ...
                          if (isEdit) {
                            ...
                            if (response) {
                              ...
                              // Get.back();
                              print("Add address successful...${Get.arguments['pageFrom']}");
                              // Check the pageFrom argument
                              if (Get.arguments != null && Get.arguments['pageFrom'] == 'cartpage') {
                                Get.to(() => CartScreen());
                              } else if (Get.arguments != null && Get.arguments['pageFrom'] == 'addresspage') {
                                Get.to(() => AddressPage());
                              } else{
                                Get.back();
                              }
