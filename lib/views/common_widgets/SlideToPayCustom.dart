...
class SlideAction extends StatefulWidget {
  ...
  /// Callback to track sliding progress from 0.0 to 1.0
  ...
  const SlideAction({
    ...
    this.trigger = 0.8,
      ...
      : assert(0.1 <= trigger &&
      trigger <= 1.0, 'The value of `trigger` should be between 0.1 and 1.0'),
        super(key: key);
...
class SlideActionState extends State<SlideAction>
  ...
  late AnimationController _checkAnimationController,
      _shrinkAnimationController, _resizeAnimationController,
    ...
    return Align(
      ...
      child: Transform(
        ...
        child: Container(
          ...
          constraints: _containerWidth != null ? null : BoxConstraints.expand(
              height: widget.height),
          child: Material(
            elevation: widget.elevation,
            color: widget.outerColor ?? Theme
                .of(context)
                .colorScheme
                .secondary,
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    ...
                    Positioned.fill(
                      right: 0,
                      child: Transform(
                        transform: Matrix4.rotationY(_checkAnimationDx *
                            (pi / 2)),
    ...
    animation.addListener(() {
      if (mounted) {
        setState(() {
          ...
          // Report progress during cancel animation
          widget.onProgressChanged?.call(_progress);
        });
      }
    });
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final RenderBox containerBox = _containerKey.currentContext!
          .findRenderObject() as RenderBox;
      _containerWidth = containerBox.size.width;
      _initialContainerWidth = _containerWidth;

      final RenderBox sliderBox = _sliderKey.currentContext!
          .findRenderObject() as RenderBox;
